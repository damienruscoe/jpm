...
function findWasmBinary() {
  return locateFile("fake_dashboard.wasm");
}
...
var _emscripten_webgl_do_create_context = (target, attributes) => {
  ...
  var contextAttributes = {
    ...
    "desynchronized": !!HEAP8[_asan_js_check_index(HEAP8, attributes + 33, ___asan_loadN)],
...
var GLFW = {
  ...
  onDrop: event => {
    ...
    for (var i = 0; i < event.dataTransfer.files.length; ++i) {
      ...
      HEAPU32[_asan_js_check_index(HEAPU32, (((filenames) + (i * 4)) >> 2), ___asan_storeN)] = filename;
    }
  ...
  getCursorPos: (winid, x, y) => {
    HEAPF64[_asan_js_check_index(HEAPF64, ((x) >> 3), ___asan_storeN)] = Browser.mouseX;
    HEAPF64[_asan_js_check_index(HEAPF64, ((y) >> 3), ___asan_storeN)] = Browser.mouseY;
  },
