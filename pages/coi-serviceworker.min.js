...
"undefined" == typeof window
    ? (self.addEventListener("install", (() => self.skipWaiting())),
       ...
       self.addEventListener(
           ...
           (e => {
                e.data &&
                ("deregister" === e.data.type ? self.registration.unregister()
                                                    .then(
                                                        (() => self.clients
                                                                   .matchAll()))
                                                    .then((e => {e.forEach(
       ...
       self.addEventListener(
           "fetch", (function(e) {
             ...
             if ("only-if-cached" === o.cache && "same-origin" !== o.mode)
               return;
             const s = coepCredentialless && "no-cors" === o.mode
             ...
             e.respondWith(
                 fetch(s)
                     .then((e => {
                       ...
                       return o.set("Cross-Origin-Embedder-Policy",
                                    coepCredentialless ? "credentialless"
                                                       : "require-corp"),
                              coepCredentialless ||
                                  o.set("Cross-Origin-Resource-Policy",
                                        "cross-origin"),
                              o.set("Cross-Origin-Opener-Policy",
                                    "same-origin"),
                              new Response(e.body, {
                                status : e.status,
    ...
    : (() => {
        ...
        const o = "coepdegrade" == e, s = {
          ...
          ...window.coi
              ...
              r = navigator, t = r.serviceWorker && r.serviceWorker.controller;
        t && !window.crossOriginIsolated &&
        ...
        !1 === window.crossOriginIsolated && s.shouldRegister() &&
                       ...
                       ? r.serviceWorker
                             ...
                             .then(
                                 (e => {
                                   ...
                                   e.active && !r.serviceWorker.controller &&
                                       (!s.quiet &&
                                            console.log(
