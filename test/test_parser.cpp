    ...
    ::testing::Values(
        ...
        ValidParserTestData{"4294967295,N,MAX-ID,S,4294967295,9999.99",
                            ...
                            {4294967295, RequestType::New, "MAX-ID", Side::Sell,
                             4294967295, FixedPointAI(99999900)}},
        ...
        ValidParserTestData{
            "1,A,A-1,S,1,0.0001",
            "Min values",
            {1, RequestType::Amend, "A-1", Side::Sell, 1, FixedPointAI(1)}},
        ...
        ValidParserTestData{
            "101,N,N,B,1000,3.2",
            "ID is RequestType N",
            {101, RequestType::New, "N", Side::Buy, 1000, FixedPointAI(32000)}},
        ValidParserTestData{
            "101,N,C,B,1000,3.2",
            "ID is RequestType C",
            {101, RequestType::New, "C", Side::Buy, 1000, FixedPointAI(32000)}},
        ValidParserTestData{
            "101,N,A,B,1000,3.2",
            "ID is RequestType A",
            {101, RequestType::New, "A", Side::Buy, 1000, FixedPointAI(32000)}},
        ValidParserTestData{
            "101,N,A001,B,1000,+0.0000",
            "Positive signed zero",
            {101, RequestType::New, "A001", Side::Buy, 1000, FixedPointAI(0)}},
        ValidParserTestData{
            "101,N,A001,B,1000,-0.0000",
