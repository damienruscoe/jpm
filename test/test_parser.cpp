...
TEST_P(ParserValidTest, ValidInput) {
  ...
  EXPECT_EQ(msg->price, param.expected.price);
}

TEST(ParserTest, MessageStreamOperator) {
  Message msg{101,    RequestType::New,
              "A001", Side::Buy,
              1000,   *FixedPoint<4>::Parse("3.2000")};
  std::stringstream ss;
  ss << msg;
    ...
    ::testing::Values(
        ...
        ValidParserTestData{"4294967295,N,MAX-ID,S,4294967295,9999.99",
                            ...
                            {4294967295, RequestType::New, "MAX-ID", Side::Sell,
                             4294967295, *FixedPoint<4>::Parse("9999.9900")}},
        ...
        ValidParserTestData{"101,N,A-B-C-1,B,1,1.1111",
                             ...
                             *FixedPoint<4>::Parse("1.1111")}},
        ValidParserTestData{"1,A,A-1,S,1,0.0001",
                            "Min values",
                            {1, RequestType::AmendPriceQuantity, "A-1",
                             Side::Sell, 1, *FixedPoint<4>::Parse("0.0001")}},
        ...
        ValidParserTestData{"101,N,00101,B,010,3.2",
                             ...
                             *FixedPoint<4>::Parse("3.2000")}},
        ValidParserTestData{"101,N,N,B,1000,3.2",
                            "ID is RequestType N",
                            {101, RequestType::New, "N", Side::Buy, 1000,
                             *FixedPoint<4>::Parse("3.2000")}},
        ValidParserTestData{"101,N,C,B,1000,3.2",
                            "ID is RequestType C",
                            {101, RequestType::New, "C", Side::Buy, 1000,
                             *FixedPoint<4>::Parse("3.2000")}},
        ValidParserTestData{"101,N,A,B,1000,3.2",
                            "ID is RequestType A",
                            {101, RequestType::New, "A", Side::Buy, 1000,
                             *FixedPoint<4>::Parse("3.2000")}},
        ValidParserTestData{"0000000000101,N,A001,B,1000,8.9000",
                            "Zero padded ticker ID",
                            {101, RequestType::New, "A001", Side::Buy, 1000,
                             *FixedPoint<4>::Parse("8.9")}},
        ValidParserTestData{"101,N,A001,B,00000000001000,8.9000",
        ...
        ValidParserTestData{
            "102,A,A001,B,3000,999999999999999999",
            "OOB Price. The quantity is within bounds of the fixed point value",
            {102, RequestType::AmendPriceQuantity, "A001", Side::Buy, 3000,
             *FixedPoint<4>::Parse("186471204942301.4128")}},
        ValidParserTestData{
            "102,A,A001,B,3000,1000000000000000000.0",
            "OOB Price. The quantity is within bounds of the fixed point value",
            {102, RequestType::AmendPriceQuantity, "A001", Side::Buy, 3000,
             *FixedPoint<4>::Parse("186471204942302.4128")}}));
