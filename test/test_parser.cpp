...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ValidParserTestData{"108,N,A008,S,1000,8.0 // , Comment with comma", "Comment with comma", {108, RequestType::New, "A008", Side::Sell, 1000, FixedPoint(80000)}},
        ...
        ValidParserTestData{"101,N,0000000000,B,1000,3.2", "Max ID length (10)", {101, RequestType::New, "0000000000", Side::Buy, 1000, FixedPoint(32000)}},
        ValidParserTestData{"101,N,ABCDEFGHIJ,B,1000,3.2", "Max ID length (10)", {101, RequestType::New, "ABCDEFGHIJ", Side::Buy, 1000, FixedPoint(32000)}},
        ValidParserTestData{"101,N,1234567890,B,1000,3.2", "Max ID length (10)", {101, RequestType::New, "1234567890", Side::Buy, 1000, FixedPoint(32000)}},
        ValidParserTestData{"101,N,---,B,1000,3.2", "Only hyphens ID", {101, RequestType::New, "---", Side::Buy, 1000, FixedPoint(32000)}},
        ...
        ValidParserTestData{"101,N,00101,B,007,3.2", "Leading zeros ID/Qty", {101, RequestType::New, "00101", Side::Buy, 7, FixedPoint(32000)}},
        ValidParserTestData{"101,N,00101,B,010,3.2", "Leading zeros ID/Qty", {101, RequestType::New, "00101", Side::Buy, 10, FixedPoint(32000)}},
